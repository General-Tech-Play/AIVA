...
export function ContactSection() {
  return (
    <section id="contact" className="pt-[130px] md:pt-[50px] space-y-8 pb-16">
      ...
      <div className="flex flex-wrap gap-4 animate-fade-in">
        <Button asChild size="lg" className="gap-2 shadow-md hover:shadow-lg transition-all duration-300 animate-fade-in hover:scale-105 min-h-[44px]" style={{ animationDelay: '0.1s' }}>
          <a href="mailto:Destinyidode@hotmail.com">
        ...
        <Button asChild size="lg" variant="outline" className="gap-2 bg-transparent hover:bg-accent/10">
          <a href="https://www.linkedin.com/in/idode-destiny/" target="_blank" rel="noopener noreferrer">
        ...
        <Button asChild size="lg" variant="outline" className="gap-2 bg-transparent hover:bg-accent/10">
          <a href="https://github.com/Holious-tech" target="_blank" rel="noopener noreferrer">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
